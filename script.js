  ...
  const tableData = [
    {
      ...
      items: [
        ...
        { desc: 'Reforce Hair', unit: 19.43, tag: '' },
        { desc: '3 Magnésios 60 Caps', unit: 11.87, tag: '' },
        ...
        { desc: 'CO-Creatin 300g (Creatina com coenzima + vitaminas) Sabor Laranja', unit: 52.00, tag: 'novo' },
        { desc: 'Curcumina com colágeno tipo 2 30ml-Gotas', unit: 14.27, tag: 'gotas' },
        { desc: 'Cúrcuma Longa com Curcumina 60caps', unit: 14.27, tag: '' },
        { desc: 'Caffeine 60caps - Microencapsulada 200mg Softgel', unit: 17.90, tag: 'novo' },
        { desc: 'CO-MAG 60caps', unit: 22.51, tag: '' },
        { desc: 'Derma B -Biotina Gummy 30gomas-Morango', unit: 30.99, tag: '' },
        { desc: 'D3 + K2 30caps - 2000UI / 159mcg', unit: 10.31, tag: '' },
        { desc: 'Ferrofor + C 60caps', unit: 11.32, tag: 'novo' },
        { desc: 'Feno Grego 60caps', unit: 11.96, tag: 'novo' },
        { desc: 'Morofor 120caps', unit: 17.47, tag: 'novo' },
        { desc: 'Melatonina Gummy 30gomas -Morango', unit: 30.55, tag: '' },
        ...
        { desc: 'Melatokalm Gotas 30ml (Melatonina)', unit: 13.94, tag: '' },
        { desc: 'Mag 6 60caps (seis magnésios)', unit: 12.51, tag: '' },
        { desc: 'Óleo de Primula 60caps Softgel', unit: 17.90, tag: '' },
        { desc: 'Ômega 3 IFOS 60caps 1gr Softgel', unit: 32.31, tag: '' },
        { desc: 'Ômega 3, 6, 9 60caps 1gr Softgel', unit: 27.06, tag: '' },
        { desc: 'PEA-600 60caps', unit: 21.03, tag: '' },
        { desc: 'Picolinato de Cromo 30caps', unit: 10.75, tag: '' },
        { desc: 'Reartron 60caps', unit: 26.01, tag: '' },
        { desc: 'Vitamina B12 30caps', unit: 10.42, tag: '' },
        { desc: 'Vitam-B12 gotas 30ml', unit: 14.27, tag: 'novo' },
        { desc: 'Vitamina K2 30caps', unit: 10.97, tag: '' },
        { desc: 'Zinco + L-Cisteina 30caps', unit: 10.20, tag: '' },
        { desc: 'SuperVita C 60caps', unit: 10.85, tag: '' }
      ]
    },
    {
      brand: '',
      ...
      items: [
        ...
        { desc: 'Ashwagandha 60caps', unit: 14.72, tag: '' },
        { desc: 'Amora Miúra 60cap', unit: 11.41, tag: '' },
        { desc: 'Amora com Isoflavona 60cap', unit: 11.52, tag: '' },
        { desc: 'Calmim 60cap', unit: 12.76, tag: '' },
        { desc: 'Canela de Velho + Sucupira 60cap', unit: 11.64, tag: '' },
        { desc: 'Carvão Vegetal 60cap', unit: 11.08, tag: '' },
        { desc: 'Castanha da Índia 60cap', unit: 12.62, tag: '' },
        { desc: 'Cloreto de Magnésio PA 60cap', unit: 10.97, tag: '' },
        { desc: 'Cloreto de Magnésio PA + Sucupira 60cap', unit: 12.16, tag: '' },
        { desc: 'Colágeno Hidrolisado 60cap', unit: 12.21, tag: '' },
        { desc: 'Colágeno Tipo 2 60cap', unit: 15.86, tag: '' },
        { desc: 'Cúrcuma 95% + Pimenta Preta 60cap', unit: 11.08, tag: '' },
        { desc: 'Espinheira Santa 60cap', unit: 11.52, tag: '' },
        { desc: 'Ginkgo Biloba 60cap', unit: 12.29, tag: '' },
        { desc: 'Ginkgo + Castanha 60cap', unit: 12.73, tag: '' },
        { desc: 'L-Treonato Magnésio 60cap', unit: 13.83, tag: '' },
        { desc: 'Maca Peruana Negra 60cap', unit: 14.60, tag: '' },
        { desc: 'Mais Ativa 60cap', unit: 10.97, tag: '' },
        { desc: 'Óleo de Abacate 1000mg 60cap', unit: 24.95, tag: 'ultimo-lote' },
        { desc: 'Óleo de Alho 500mg 60cap', unit: 16.36, tag: '' },
        { desc: 'Óleo de Semente de Abóbora 1000mg 60cap', unit: 26.10, tag: '' },
        { desc: 'Ora Pro Nóbis 60cap', unit: 12.07, tag: '' },
        { desc: 'Seca Barriga com Laranja MORO 60cap', unit: 12.40, tag: '' },
        { desc: 'Tibulus Terrestris 40% 60cap', unit: 12.07, tag: '' },
        { desc: 'Tribulus + Maca Peruana 60cap', unit: 11.74, tag: '' },
        { desc: 'Uxi Amarelo + Unha de Gato 60cap', unit: 11.63, tag: '' },
        { desc: 'Valeriana 60cap', unit: 15.37, tag: '' },
